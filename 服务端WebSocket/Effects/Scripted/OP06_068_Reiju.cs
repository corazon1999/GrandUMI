...
/// <summary>
/// OP06-068 温思默克·丽久（费用2 角色）
/// 【启动主要】咚!!-1（可以将我方场上指定数量的咚‼放回咚‼卡组），可以将此角色放置到废弃区：
/// 我方领袖拥有《GERMA 66》特征的场合，将我方手牌或废弃区中最多 1 张费用为 4 的"温思默克·丽久"登场。
///
/// 实现说明：同 OP06-064/066，区别为目标名为"温思默克·丽久"且费用为 4。
/// </summary>
