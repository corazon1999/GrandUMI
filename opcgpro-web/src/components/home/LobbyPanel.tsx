  ...
  return (
    <div id="rank-faction-rules" className="mt-2 rounded-xl border border-violet-800/60 bg-black/20 p-3 text-xs leading-5 text-gray-300">
      ...
      <ul className="mt-3 list-disc space-y-1 pl-4 text-gray-400">
        ...
        <li>悬赏金达到 1亿5000万但未达到 10亿贝里时，基础胜负变为增加或减少 400万贝里；连胜奖励、连败保护和分差修正上限全部翻倍，分别最高为 200万、100万和 100万贝里。</li>
        <li>悬赏金达到 10亿贝里后再次翻倍：基础胜负增加或减少 800万贝里；连胜奖励、连败保护和分差修正上限分别最高为 400万、200万和 200万贝里。</li>
        <li>第一阶不因失败降低显示悬赏金，第二、三阶拥有大段保护；每局结算会逐项展示悬赏金变化。</li>
        <li>进入新世界后，海贼、海军、世界政府普通玩家分别显示超新星、大将候补、深海契约；阵营前列玩家会获得海贼王、四皇、海军元帅、海军大将、世界之王或五老星称号。</li>
